---
title: "Clasificador diseasecodes TCGA. Red neuronal con sondas diferencialmente metiladas Tumor vs. Resto"
...
# Selección de las  sondas elegidas por su metilación diferencial Tumor vs resto

```{r metilacion_diferencial, cache=TRUE}
...
### Selección de sondas con mayores diferencias en las medias betas

```{r seleccion, cache=TRUE}
...
## Subsetting del objeto SummarizedExperiment

```{r, eval=FALSE}

##########################################################
# Subseting en el summarizedExperiment train
##############################################################
