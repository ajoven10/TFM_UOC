---
title: "Clasificador diseasecodes TCGA. Red neuronal con sondas elegidas aleatoriamente"
...
# Selección de las  sondas aleatoriamente
...
GSE42409_df <- dplyr::select(GSE42409_df, c(1,6,12,13,14))
...
### Selección aleatoria de 10.000 sondas y muestras solo tumores primarios

```{r seleccion, eval=FALSE}

data_sondas_dep <- data_dep[sample(1:dim(sondas_dep)[1], 10000) , ]
save(data_sondas_dep, file="G:/TFM UOC/datos/Clasificador_sondas_aleatorias/data_sondas_dep.Rda")
gc()
