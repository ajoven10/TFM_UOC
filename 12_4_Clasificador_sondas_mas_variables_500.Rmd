---
title: "Clasificador diseasecodes TCGA. Red neuronal con 500 sondas de mayor variabilidad"
...
# Selección de las 500 sondas con mayor variabilidad
...
## Selección de las 500 sondas de mayor desviación estándar
...
sondas_500 <- selecciona_sondas(data_sondas_dep, n)
save(sondas_500, file="G:/TFM UOC/datos/Clasificador_variabilidad/sondas_500.Rda")
...
load(file="G:/TFM UOC/datos/Clasificador_variabilidad/sondas_500.Rda")
sondas_500

df <- rowRanges(sondas_500)$sd 
df <- data.frame(sd = df)
...
set.seed(123)
etiqueta <- sondas_500$label

in_train <- createDataPartition(etiqueta, p=0.75, list=FALSE) %>% as.vector()

train <- sondas_500[ , in_train]
test <- sondas_500[ , -in_train] 
train
test
