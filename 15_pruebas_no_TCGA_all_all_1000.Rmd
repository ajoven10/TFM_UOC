---
title: 'Clasificador: prueba no TCGA'
...
```{r}
load("G:/TFM UOC/datos/Clasificador_variabilidad/sondas_all_all_sd_1000.Rda")
sondas_1000
...
```{r entrenamiento_modelo, cache=TRUE}
modelo <- build_model()
...
save_model_hdf5(modelo, "G:/TFM UOC/datos/Clasificador_variabilidad/modelo_1000_all_all.h5")
...
En el mensaje de aviso vemos que había 88 sondas en el subset de sondas más variables que no estaban en los datos de colonomics
